...
LOG_DIR = PROJECT_ROOT / "log_config"  # 日志目录

# 确保目录存在
for dir_path in [IMAGE_DIR, NEW_PRODUCT_DIR, OUTPUT_DIR, LOG_DIR]:
...
# ==================== 稀疏向量配置 ====================
# 选择稀疏向量生成方法: "tfidf" 或 "bm25"
# BM25 通常比 TF-IDF 效果提升 5-15%
SPARSE_METHOD = os.environ.get("SPARSE_METHOD", "bm25").lower()
USE_BM25 = SPARSE_METHOD == "bm25"

# BM25 参数 (仅当 USE_BM25=True 时生效)
BM25_K1 = 1.5   # 词频饱和参数 (1.0-2.0, 默认 1.5)
BM25_B = 0.75   # 长度归一化参数 (0-1, 默认 0.75)
...
print(f"稀疏向量方法: {SPARSE_METHOD.upper()} ({'BM25' if USE_BM25 else 'TF-IDF'})")
